...
// // this will be handler class for now as long as mapping is Client<->Bucket
// class Client{
//   final String _id;
//   final String _name;
...
//
//   Client(this._id, this._name, this._clientId, this._clientKey, this._isActive, this._isDefault, this._bucket);
//
//   Client.empty()
//       : _id = '',
//         _name = '',
...
//         _isActive = false,
//         _isDefault = false,
//         _bucket = Bucket.empty();
//
//
//   Client.withBucket(Bucket b)
//       : _id = '',
//         _name = '',
//         _clientId = '',
//         _clientKey = '',
...
//     }
//     try{
//       _logger.fine("URL: " + '${Config.wsHost}${Config.webSocketURL}${_bucket.id}/');
//       Uri uri = Uri.parse('${Config.wsHost}${Config.webSocketURL}${_bucket.id}/');
...
//     try{
//       WebSocketChannel localWSChannel = await WSHandler.updateChannel(this._bucket.id);
//
